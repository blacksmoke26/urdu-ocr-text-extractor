  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2 p-1 rounded-xl bg-gray-100 dark:bg-white/5 border border-gray-300/60 dark:border-slate-200/40">
        ...
        <div className="glass-card rounded-2xl p-6 relative overflow-hidden">
          ...
          <div className="relative">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-xs font-medium text-slate-600 dark:text-slate-400 uppercase tracking-wider">Uptime</span>
            </div>
            <p className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">{formatUptime(stats.uptime_seconds)}</p>
        ...
        <div className="glass-card rounded-2xl p-6 relative overflow-hidden">
          ...
          <div className="relative">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-xs font-medium text-slate-600 dark:text-slate-400 uppercase tracking-wider">Requests</span>
            </div>
            <p className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">{stats.total_requests.toLocaleString()}</p>
            <div className="flex items-center gap-1 mt-2">
              <TrendingUp className="h-3 w-3 text-emerald-500 dark:text-emerald-400" />
              <span className="text-xs text-slate-600 dark:text-slate-500">Total handled</span>
            </div>
          </div>
        </div>
        ...
        <div className="glass-card rounded-2xl p-6 relative overflow-hidden">
          ...
          <div className="relative">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-xs font-medium text-slate-600 dark:text-slate-400 uppercase tracking-wider">OCR RPS</span>
            </div>
            <p className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">{stats.ocr_requests_per_second.toFixed(1)}</p>
            <div className="flex items-center gap-1 mt-2">
              <ArrowUpRight className="h-3 w-3 text-emerald-500 dark:text-emerald-400" />
              <span className="text-xs text-slate-600 dark:text-slate-500">Requests/sec</span>
            </div>
          </div>
        </div>
        ...
        <div className="glass-card rounded-2xl p-6 relative overflow-hidden">
          ...
          <div className="relative">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-xs font-medium text-slate-600 dark:text-slate-400 uppercase tracking-wider">Failures</span>
            </div>
            <p className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">{stats.ocr_failures.toLocaleString()}</p>
            <div className="flex items-center gap-1 mt-2">
              {stats.ocr_failures > 0 ? (
                <><ArrowUpRight className="h-3 w-3 text-red-500 dark:text-red-400" /><span className="text-xs text-red-600 dark:text-red-400">Needs attention</span></>
              ) : (
                <><span className="inline-flex h-1.5 w-1.5 rounded-full bg-emerald-500 dark:bg-emerald-400" /><span className="text-xs text-slate-600 dark:text-slate-500">All clear</span></>
              )}
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="glass-card rounded-2xl p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-sm font-semibold text-slate-900 dark:text-white">GPU Memory</span>
          </div>
          <div className="space-y-3">
            <div className="flex items-end justify-between">
              <div>
                <p className="text-2xl font-bold text-slate-900 dark:text-white">{stats.gpu_memory_used_gb.toFixed(1)}</p>
                <p className="text-xs text-slate-600 dark:text-slate-500">GB used</p>
              </div>
              <div className="text-right">
                <p className="text-xs text-slate-600 dark:text-slate-400">of {stats.gpu_memory_total_gb} GB</p>
                <p className="text-lg font-semibold text-blue-500 dark:text-blue-400">{Math.round((stats.gpu_memory_used_gb / stats.gpu_memory_total_gb) * 100)}%</p>
              </div>
            </div>
            <div className="h-3 rounded-full bg-slate-200/80 dark:bg-slate-800/80 overflow-hidden">
              <div
        ...
        <div className="glass-card rounded-2xl p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-sm font-semibold text-slate-900 dark:text-white">RAM Usage</span>
          </div>
          <div className="space-y-3">
            <div className="flex items-end justify-between">
              <div>
                <p className="text-2xl font-bold text-slate-900 dark:text-white">{stats.memory_used_gb.toFixed(1)}</p>
                <p className="text-xs text-slate-600 dark:text-slate-500">GB used</p>
              </div>
              <div className="text-right">
                <p className="text-xs text-slate-600 dark:text-slate-400">of {stats.memory_total_gb} GB</p>
                <p className="text-lg font-semibold text-purple-500 dark:text-purple-400">{Math.round((stats.memory_used_gb / stats.memory_total_gb) * 100)}%</p>
              </div>
            </div>
            <div className="h-3 rounded-full bg-slate-200/80 dark:bg-slate-800/80 overflow-hidden">
              <div
        ...
        <div className="glass-card rounded-2xl p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-sm font-semibold text-slate-900 dark:text-white">CPU Usage</span>
          </div>
          <div className="space-y-3">
            <div className="flex items-end justify-between">
              <div>
                <p className={`text-2xl font-bold ${stats.cpu_percent > 80 ? 'text-red-500 dark:text-red-400' : stats.cpu_percent > 60 ? 'text-amber-500 dark:text-amber-400' : 'text-emerald-500 dark:text-emerald-400'}`}>
                  {stats.cpu_percent}%
                </p>
                <p className="text-xs text-slate-600 dark:text-slate-500">Current load</p>
              </div>
            </div>
            <div className="h-3 rounded-full bg-slate-200/80 dark:bg-slate-800/80 overflow-hidden">
              <div
      ...
      <div className="glass-card rounded-2xl p-8 relative overflow-hidden">
        ...
        <div className="relative text-center">
          <Zap className="h-6 w-6 text-violet-500 dark:text-violet-400 mx-auto mb-3" />
          <p className="text-sm font-medium text-slate-600 dark:text-slate-400 uppercase tracking-wider mb-1">Total Lines Extracted</p>
      ...
      {Object.keys(perApi).length > 0 && (
        <div className="glass-card rounded-2xl p-6">
          <h3 className="text-sm font-semibold text-slate-900 dark:text-white mb-4">Per-Endpoint Metrics</h3>
          <div className="space-y-1">
            {Object.entries(perApi).map(([name, s]) => (
              <div key={name} className={`flex items-center justify-between px-4 py-3 rounded-xl transition-colors ${
                ...
                <span className="font-medium text-sm capitalize text-slate-900 dark:text-slate-200">{name.replace(/_/g, ' ')}</span>
...
function LatencyCard({ title, data }: { title: string; data?: LiveStats['latency_global'] | LiveStats['latency_ocr'] }) {
  if (!data) return (
    <div className="glass-card rounded-2xl p-6">
      <p className="text-sm text-slate-600 dark:text-slate-500 italic">No latency data available</p>
    </div>
  );
            ...
            {bars.map(({ label, value, color }) => (
              <div key={label}>
                <div className="flex justify-between items-center text-xs mb-1.5">
                  ...
                  <span className="font-bold text-slate-900 dark:text-white">{Math.round(value)}ms</span>
                </div>
                <div className="h-2.5 rounded-full bg-slate-200/80 dark:bg-slate-800/80 overflow-hidden">
                  <div
